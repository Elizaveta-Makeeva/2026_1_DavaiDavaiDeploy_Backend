...
var file_auth_proto_goTypes = []any{
	...
	(*ValidateAndGetUserRequest)(nil), // 11: auth.ValidateAndGetUserRequest
}
var file_auth_proto_depIdxs = []int32{
	2,  // 0: auth.AuthResponse.User:type_name -> auth.UserResponse
	3,  // 1: auth.Auth.SignupUser:input_type -> auth.SignupRequest
	4,  // 2: auth.Auth.SignInUser:input_type -> auth.SignInRequest
	9,  // 3: auth.Auth.LogOutUser:input_type -> auth.LogOutUserRequest
	...
	11, // 7: auth.Auth.ValidateAndGetUser:input_type -> auth.ValidateAndGetUserRequest
	0,  // 8: auth.Auth.SignUpUserVK:input_type -> auth.SignupVKRequest
	0,  // 9: auth.Auth.SignInUserVK:input_type -> auth.SignupVKRequest
	5,  // 10: auth.Auth.SignupUser:output_type -> auth.AuthResponse
	5,  // 11: auth.Auth.SignInUser:output_type -> auth.AuthResponse
	10, // 12: auth.Auth.LogOutUser:output_type -> auth.LogOutUserResponse
	2,  // 13: auth.Auth.GetUser:output_type -> auth.UserResponse
	5,  // 14: auth.Auth.ChangePassword:output_type -> auth.AuthResponse
	5,  // 15: auth.Auth.ChangeAvatar:output_type -> auth.AuthResponse
	2,  // 16: auth.Auth.ValidateAndGetUser:output_type -> auth.UserResponse
	5,  // 17: auth.Auth.SignUpUserVK:output_type -> auth.AuthResponse
	5,  // 18: auth.Auth.SignInUserVK:output_type -> auth.AuthResponse
