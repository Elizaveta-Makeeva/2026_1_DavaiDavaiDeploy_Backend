...
type UsersUsecase interface {
	...
	UploadDance(ctx context.Context, buffer []byte, fileFormat string) (resultKey string, segmentsKey string, numFrames int, numSegments int, durationSec float64, err error)
}
